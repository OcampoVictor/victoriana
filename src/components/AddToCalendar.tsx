...
export default function AddToCalendar() {
  ...
  return (
    <div className="w-full flex justify-center py-12 bg-paper border-b-2 border-secondary/20">
      <div className="layout-content-container flex flex-col items-center max-w-[800px] flex-1 px-4 text-center">
