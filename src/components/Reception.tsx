...
export default function Reception() {
  return (
    <div className="w-full flex justify-center py-20 bg-paper border-b border-secondary/20 relative overflow-hidden">
      <div className="layout-content-container flex flex-col max-w-[1080px] flex-1 px-4 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div 
            ...
            className="relative w-full aspect-[4/3] lg:aspect-square border-4 border-double border-secondary bg-[#E8E0D5] overflow-hidden order-1 lg:order-1 shadow-2xl"
          >
            <img 
              src="https://i.postimg.cc/yYTrCNw6/tema_victoriana_hacienda.png" 
